...
def cal_pop_fitness(pop):
    ...
    for row in pop:
        ...
        # Calculate the win percentage against the second strategy
        win_percentage_two = white_win_count / num_games

        # Take the average win percentage as our "fitness level"
        fitness.append((win_percentage_one + win_percentage_two) / 2)
